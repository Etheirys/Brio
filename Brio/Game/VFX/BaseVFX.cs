...
public unsafe struct VfxResourceInstance
{
    ...
    [FieldOffset(0xB4)] public int PlayMode;
    [FieldOffset(0xB5)] public int SpeedFlag;
    [FieldOffset(0xC4)] public int ActiveFlag;
}
...
public abstract unsafe class BaseVFX : IDisposable
{
    ...
    public bool IsValid => VFXObject != null && (IntPtr)VFXObject != IntPtr.Zero;
